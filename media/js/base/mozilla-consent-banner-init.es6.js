...
function openBanner() {
    ...
    document
        ...
        .addEventListener('click', MozConsentBanner.onAcceptAll, false);
    document
        .getElementById('moz-consent-banner-button-reject')
        .addEventListener('click', MozConsentBanner.onRejectAll, false);
...
function closeBanner() {
    ...
    document
        .getElementById('moz-consent-banner-button-accept')
        .removeEventListener('click', MozConsentBanner.onAcceptAll, false);
    document
        .getElementById('moz-consent-banner-button-reject')
        .removeEventListener('click', MozConsentBanner.onRejectAll, false);
