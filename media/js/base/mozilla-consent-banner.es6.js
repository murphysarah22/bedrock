...
const EVENT_NAME_CHANGE = 'mozConsentChange';
...
MozConsentBanner.onAcceptAll = () => {
    ...
    MozConsentBanner.dispatchEvent(EVENT_NAME_CHANGE, preferences);
