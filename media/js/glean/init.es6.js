 ...
 * When `telemetryEnabled = true`, Glean will send analytics pings as normal.
 * When `telemetryEnabled = false`, Glean will instead sent `deletion-request`
 * pings to automatically remove a person's analytics data.
 */
